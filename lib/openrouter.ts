...
export async function detectTeam(
  ...
  const prompt = `Проанализируй следующий текст и определи, какая команда и подтип задачи подходят лучше всего.
...
{
  "teamId": "id_команды",
  "subtypeId": "id_подтипа" (или null, если подтипа нет)
}
